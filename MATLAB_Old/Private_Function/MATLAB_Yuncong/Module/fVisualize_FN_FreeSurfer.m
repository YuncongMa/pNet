function fVisualize_FN_FreeSurfer(File_FN,File_Brain_Surface,Dir_Figure)
% Yuncong Ma, 3/1/2023
...
for i=1:k
    ...
    Image=fHCP_FS_6View_Column(Brain_Surface.Shape_Inflated,fHCP_To_32K(squeeze(Center(i,:))',Brain_Surface.MW.LR),...
        fColor_Theme('Seed_Map_3_Positive',round(100*[threshold/2,threshold])/100),{'Material','dull'});
