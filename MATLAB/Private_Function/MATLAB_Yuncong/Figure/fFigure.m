function Axes=fFigure(Figure_Number,Total_Figure_Number,Organization_Matrix,Figure_Title,Figure_Size,varargin)
% By Yuncong Ma, 3/21/2023
% Axes=fFigure(Figure_Number,Total_Figure_Number,Organization_Matrix,Figure_Title,Figure_Size)
...
if Figure_Number==1 && Total_Figure_Number==1
    ...
    Axes=figure('Name',Figure_Title,'NumberTitle','off','Position',[Figure_Position,Figure_Size]);
    return
end
