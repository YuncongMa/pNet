...
# Use half subjects to do 2fold
# bash /cbica/home/mayun/Projects/NMF/scripts/HCP_SGC/run_get_data_2F.sh
####################################################################################
...
MATLAB_function=fGet_Data_HCP_1200_2F

# log file
file_log=${dir_main}/sge_output/step0/run_get_data_2F.log
