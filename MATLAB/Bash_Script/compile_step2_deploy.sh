...
####################################################################################
# Yuncong Ma, 10/24/2022
# It is to compile selRobustInit.m
# bash /cbica/home/mayun/Projects/NMF/scripts/HCP_SGC/compile_step2_deploy.sh
####################################################################################
...
function_name=selRobustInit
dir_output=${dir_code}

file_log=${dir_main}/sge_output/step2/compile_step2_deploy.log
if test -f "${file_log}"
then
    rm $file_log
fi
