...
# bash /cbica/home/mayun/Projects/NMF/scripts/HCP_SGC/visualize_step3_All_HCP_Test.sh
####################################################################################
...
parse()
{
    ...
    subset=/All
    dir_log=/cbica/home/mayun/Projects/NMF/sge_output
    file_log_main=/cbica/home/mayun/Projects/NMF/sge_output/step3/visualize_step3_All_HCP_FS.log
...
for i in $(seq 0 $N)
do
    dir_result=${dir_main}/Result/${dataset}${subset}/FN_${K}_Test/Individual/${sbjFolderarray[i]}
