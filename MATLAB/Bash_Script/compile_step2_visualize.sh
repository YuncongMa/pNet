...
####################################################################################
# Yuncong Ma, 9/20/2022
# It is to compile fVisualize_NMF_Step3_HCP_FS.m
# bash /cbica/home/mayun/Projects/NMF/scripts/HCP_SGC/compile_step2_visualize.sh
####################################################################################
...
function_name=fVisualize_NMF_Step2_HCP_FS
dir_output=${dir_code}

file_log=${dir_main}/sge_output/step3/compile_step2_visualize.log
if test -f "${file_log}"
then
    rm $file_log
fi
