...
# bash /cbica/home/mayun/Projects/NMF/scripts/PNC_SGC/submit_step2_All_HCP_Test.sh
####################################################################################
...
dir_init=/cbica/home/mayun/Projects/NMF/Result/${dataset}${subset}/FN_${K}_Test
...
# log
file_log=$dir_log/step2/submit_step2_All_HCP.log
