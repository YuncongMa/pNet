...
# bash /cbica/home/mayun/Projects/NMF/scripts/HCP_SGC/visualize_step3_All_HCP.sh
####################################################################################
...
for i in $(seq 0 $N)
do
    dir_result=${dir_main}/Result/${dataset}${subset}/FN_${K}/Individual/${sbjFolderarray[i]}
